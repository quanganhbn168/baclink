...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('settings', function (Blueprint $table) {
            ...
            $table->string('bank_qr_template')->nullable()->default('compact')->after('bank_account_name');
        });
    }
    ...
    {
        Schema::table('settings', function (Blueprint $table) {
            $table->dropColumn(['bank_name', 'bank_account_no', 'bank_account_name', 'bank_qr_template']);
        });
    }
};
