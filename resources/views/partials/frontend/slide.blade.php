                ...
                <div class="slide-overlay">
                    <div class="container container-custom h-100 d-flex flex-column justify-content-center align-items-start">
                        <div class="slide-content">
                            <h2 class="slide-subtext text-gold mb-2" style="font-family: var(--font-secondary); font-weight: 700; text-transform: uppercase; font-size: 1.5rem;">{{ __('frontend.key_industries') }}</h2>
                            ...
                            <a href="{{ route('register') }}" class="btn btn-gold-cta" style="padding: 15px 40px; font-size: 1.1rem;">{{ __('frontend.register_member') }} <i class="fa fa-arrow-right ml-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
